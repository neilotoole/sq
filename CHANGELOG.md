...
- [#1225]: A malformed selector inside `order_by()` is now reported, instead of
  being silently dropped and the query running unordered.
...
[#1225]: https://github.com/neilotoole/sq/issues/1225
