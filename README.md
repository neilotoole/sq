...
- Thanks to [Diego de Souza Mendes](https://aur.archlinux.org/account/diegosouza) for creating the [Arch Linux package](https://aur.archlinux.org/packages/sq-bin).
