...
func TestCmdInspect_markdown(t *testing.T) { //nolint:tparallel
	...
	// A "generated by sq" provenance line is rendered under the title (the CLI
	// stamps Printing with a timestamp; see run.go), with "sq" linked to docs.
	require.Contains(t, out, "generated by [`sq`](https://sq.io/docs/inspect)")
