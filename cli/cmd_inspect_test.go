...
func TestCmdInspect_markdown(t *testing.T) { //nolint:tparallel
	...
	// A "generated by" provenance line is rendered under the title (the CLI
	// stamps Printing with the invocation; see run.go), with "sq" linked.
	require.Contains(t, out, "generated by [`sq`](https://sq.io) `inspect")
