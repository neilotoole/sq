...
func TestMetadataWriter_provenance(t *testing.T) {
	...
	// No command is emitted: just the timestamp and a "sq" link (the <a> inside
	// the <code>) pointing at the inspect docs.
	const want = `<p class="sq-gen">2026-05-22T13:14:15Z · generated by ` +
	...
	// Omitted when no generation info is set.
	...
	require.NotContains(t, plainBuf.String(), "generated by")
}
