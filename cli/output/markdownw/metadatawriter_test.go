...
func TestMetadataWriter_provenance(t *testing.T) {
	...
	pr.GeneratedBy = "sq inspect @test --markdown"
	// "sq" links to sq.io as its own code chip (Markdown can't nest a link in
	// a single code span); the rest of the command follows as code.
	const want = "*2026-05-22T13:14:15Z · generated by " +
		"[`sq`](https://sq.io) `inspect @test --markdown`*"
