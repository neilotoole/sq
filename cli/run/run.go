...
type Run struct {
	...
	// Invocation is the full argument slice as passed to ExecuteWith
	// (subcommand, flags, and operands), used to render the "generated by"
	// provenance line in inspect's Markdown/HTML output. Unlike Args (which
	// cobra reduces to operands), this is the complete command line.
	Invocation []string
}
