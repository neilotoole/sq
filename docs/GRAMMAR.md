...
The [`grammar/`](../grammar/) directory contains the formal grammar
(`SLQ.g4`, written in [ANTLR4](https://www.antlr.org/) syntax) and the tooling
that turns it into a Go parser. This document is the high-level companion to
[`SLQ.g4`](../grammar/SLQ.g4): read this first, then dive into the grammar file
for the rule-by-rule detail.
...
Quick reference for every element kind. See [`SLQ.g4`](../grammar/SLQ.g4) for the
...
1. Update [`SLQ.g4`](../grammar/SLQ.g4): keep comments adjacent to the rules they
   describe.
...
- [`SLQ.g4`](../grammar/SLQ.g4): the grammar itself, extensively commented.
