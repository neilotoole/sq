...
func renderRange(_ *render.Context, _ *render.Renderer, rr *ast.RowRangeNode) (string, error) {
	if rr == nil {
		return "", nil
	}
...
func preRender(_ *render.Context, _ *render.Renderer, f *render.Fragments) error {
