#!/usr/bin/env bash
#
# common.bash - Shared utilities for SQ integration tests
#
# This file contains common functions that can be used by any integration test script:
...
#   DRIVER_DIR - Parent directory (itesth)
