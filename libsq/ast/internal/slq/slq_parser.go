...
func slqParserInit() {
	...
	staticData.serializedATN = []int32{
		...
		46, 48, 50, 0, 8, 1, 0, 34, 39, 1, 0, 17, 18, 1, 0, 21, 22, 2, 0, 2, 2,
		8, 9, 1, 0, 10, 12, 1, 0, 34, 37, 2, 0, 31, 33, 42, 42, 2, 0, 14, 15, 17,
		18, 284, 0, 55, 1, 0, 0, 0, 2, 76, 1, 0, 0, 0, 4, 84, 1, 0, 0, 0, 6, 103,
		1, 0, 0, 0, 8, 105, 1, 0, 0, 0, 10, 107, 1, 0, 0, 0, 12, 111, 1, 0, 0,
		0, 14, 126, 1, 0, 0, 0, 16, 128, 1, 0, 0, 0, 18, 138, 1, 0, 0, 0, 20, 140,
		1, 0, 0, 0, 22, 142, 1, 0, 0, 0, 24, 155, 1, 0, 0, 0, 26, 157, 1, 0, 0,
		0, 28, 169, 1, 0, 0, 0, 30, 173, 1, 0, 0, 0, 32, 185, 1, 0, 0, 0, 34, 189,
		1, 0, 0, 0, 36, 196, 1, 0, 0, 0, 38, 198, 1, 0, 0, 0, 40, 200, 1, 0, 0,
		0, 42, 203, 1, 0, 0, 0, 44, 205, 1, 0, 0, 0, 46, 226, 1, 0, 0, 0, 48, 258,
		1, 0, 0, 0, 50, 260, 1, 0, 0, 0, 52, 54, 5, 1, 0, 0, 53, 52, 1, 0, 0, 0,
		54, 57, 1, 0, 0, 0, 55, 53, 1, 0, 0, 0, 55, 56, 1, 0, 0, 0, 56, 58, 1,
		0, 0, 0, 57, 55, 1, 0, 0, 0, 58, 67, 3, 2, 1, 0, 59, 61, 5, 1, 0, 0, 60,
		59, 1, 0, 0, 0, 61, 62, 1, 0, 0, 0, 62, 60, 1, 0, 0, 0, 62, 63, 1, 0, 0,
		0, 63, 64, 1, 0, 0, 0, 64, 66, 3, 2, 1, 0, 65, 60, 1, 0, 0, 0, 66, 69,
		1, 0, 0, 0, 67, 65, 1, 0, 0, 0, 67, 68, 1, 0, 0, 0, 68, 73, 1, 0, 0, 0,
		69, 67, 1, 0, 0, 0, 70, 72, 5, 1, 0, 0, 71, 70, 1, 0, 0, 0, 72, 75, 1,
		0, 0, 0, 73, 71, 1, 0, 0, 0, 73, 74, 1, 0, 0, 0, 74, 1, 1, 0, 0, 0, 75,
		73, 1, 0, 0, 0, 76, 81, 3, 4, 2, 0, 77, 78, 5, 29, 0, 0, 78, 80, 3, 4,
		2, 0, 79, 77, 1, 0, 0, 0, 80, 83, 1, 0, 0, 0, 81, 79, 1, 0, 0, 0, 81, 82,
		1, 0, 0, 0, 82, 3, 1, 0, 0, 0, 83, 81, 1, 0, 0, 0, 84, 89, 3, 6, 3, 0,
		85, 86, 5, 28, 0, 0, 86, 88, 3, 6, 3, 0, 87, 85, 1, 0, 0, 0, 88, 91, 1,
		0, 0, 0, 89, 87, 1, 0, 0, 0, 89, 90, 1, 0, 0, 0, 90, 5, 1, 0, 0, 0, 91,
		89, 1, 0, 0, 0, 92, 104, 3, 40, 20, 0, 93, 104, 3, 42, 21, 0, 94, 104,
		3, 34, 17, 0, 95, 104, 3, 16, 8, 0, 96, 104, 3, 26, 13, 0, 97, 104, 3,
		30, 15, 0, 98, 104, 3, 44, 22, 0, 99, 104, 3, 20, 10, 0, 100, 104, 3, 22,
		11, 0, 101, 104, 3, 10, 5, 0, 102, 104, 3, 46, 23, 0, 103, 92, 1, 0, 0,
		...
		104, 7, 1, 0, 0, 0, 105, 106, 7, 0, 0, 0, 106, 9, 1, 0, 0, 0, 107, 109,
		3, 12, 6, 0, 108, 110, 3, 36, 18, 0, 109, 108, 1, 0, 0, 0, 109, 110, 1,
		0, 0, 0, 110, 11, 1, 0, 0, 0, 111, 112, 3, 14, 7, 0, 112, 122, 5, 24, 0,
		0, 113, 118, 3, 46, 23, 0, 114, 115, 5, 28, 0, 0, 115, 117, 3, 46, 23,
		0, 116, 114, 1, 0, 0, 0, 117, 120, 1, 0, 0, 0, 118, 116, 1, 0, 0, 0, 118,
		119, 1, 0, 0, 0, 119, 123, 1, 0, 0, 0, 120, 118, 1, 0, 0, 0, 121, 123,
		5, 2, 0, 0, 122, 113, 1, 0, 0, 0, 122, 121, 1, 0, 0, 0, 122, 123, 1, 0,
		0, 0, 123, 124, 1, 0, 0, 0, 124, 125, 5, 25, 0, 0, 125, 13, 1, 0, 0, 0,
		126, 127, 5, 22, 0, 0, 127, 15, 1, 0, 0, 0, 128, 129, 5, 3, 0, 0, 129,
		130, 5, 24, 0, 0, 130, 131, 3, 18, 9, 0, 131, 132, 5, 25, 0, 0, 132, 17,
		1, 0, 0, 0, 133, 134, 3, 32, 16, 0, 134, 135, 3, 8, 4, 0, 135, 136, 3,
		32, 16, 0, 136, 139, 1, 0, 0, 0, 137, 139, 3, 32, 16, 0, 138, 133, 1, 0,
		0, 0, 138, 137, 1, 0, 0, 0, 139, 19, 1, 0, 0, 0, 140, 141, 5, 4, 0, 0,
		141, 21, 1, 0, 0, 0, 142, 148, 5, 5, 0, 0, 143, 145, 5, 24, 0, 0, 144,
		146, 3, 32, 16, 0, 145, 144, 1, 0, 0, 0, 145, 146, 1, 0, 0, 0, 146, 147,
		1, 0, 0, 0, 147, 149, 5, 25, 0, 0, 148, 143, 1, 0, 0, 0, 148, 149, 1, 0,
		0, 0, 149, 151, 1, 0, 0, 0, 150, 152, 3, 36, 18, 0, 151, 150, 1, 0, 0,
		0, 151, 152, 1, 0, 0, 0, 152, 23, 1, 0, 0, 0, 153, 156, 3, 32, 16, 0, 154,
		156, 3, 12, 6, 0, 155, 153, 1, 0, 0, 0, 155, 154, 1, 0, 0, 0, 156, 25,
		1, 0, 0, 0, 157, 158, 5, 16, 0, 0, 158, 159, 5, 24, 0, 0, 159, 164, 3,
		24, 12, 0, 160, 161, 5, 28, 0, 0, 161, 163, 3, 24, 12, 0, 162, 160, 1,
		0, 0, 0, 163, 166, 1, 0, 0, 0, 164, 162, 1, 0, 0, 0, 164, 165, 1, 0, 0,
		0, 165, 167, 1, 0, 0, 0, 166, 164, 1, 0, 0, 0, 167, 168, 5, 25, 0, 0, 168,
		27, 1, 0, 0, 0, 169, 171, 3, 32, 16, 0, 170, 172, 7, 1, 0, 0, 171, 170,
		1, 0, 0, 0, 171, 172, 1, 0, 0, 0, 172, 29, 1, 0, 0, 0, 173, 174, 5, 19,
		0, 0, 174, 175, 5, 24, 0, 0, 175, 180, 3, 28, 14, 0, 176, 177, 5, 28, 0,
		0, 177, 179, 3, 28, 14, 0, 178, 176, 1, 0, 0, 0, 179, 182, 1, 0, 0, 0,
		180, 178, 1, 0, 0, 0, 180, 181, 1, 0, 0, 0, 181, 183, 1, 0, 0, 0, 182,
		180, 1, 0, 0, 0, 183, 184, 5, 25, 0, 0, 184, 31, 1, 0, 0, 0, 185, 187,
		...
		193, 197, 5, 20, 0, 0, 194, 195, 5, 30, 0, 0, 195, 197, 7, 2, 0, 0, 196,
		...
		205, 214, 5, 6, 0, 0, 206, 207, 5, 32, 0, 0, 207, 208, 5, 30, 0, 0, 208,
		215, 5, 32, 0, 0, 209, 210, 5, 32, 0, 0, 210, 215, 5, 30, 0, 0, 211, 212,
		5, 30, 0, 0, 212, 215, 5, 32, 0, 0, 213, 215, 5, 32, 0, 0, 214, 206, 1,
		0, 0, 0, 214, 209, 1, 0, 0, 0, 214, 211, 1, 0, 0, 0, 214, 213, 1, 0, 0,
		0, 214, 215, 1, 0, 0, 0, 215, 216, 1, 0, 0, 0, 216, 217, 5, 27, 0, 0, 217,
...
func (p *SLQParser) Func_() (localctx IFuncContext) {
	...
	case SLQParserT__13, SLQParserT__14, SLQParserORDER_ASC, SLQParserORDER_DESC, SLQParserARG, SLQParserID, SLQParserNULL, SLQParserNN, SLQParserNUMBER, SLQParserNAME, SLQParserSTRING:
		{
			p.SetState(113)
			p.expr(0)
		}
