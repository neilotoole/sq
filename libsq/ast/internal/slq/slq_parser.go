...
func slqParserInit() {
	...
	staticData.serializedATN = []int32{
		4, 1, 51, 283, 2, 0, 7, 0, 2, 1, 7, 1, 2, 2, 7, 2, 2, 3, 7, 3, 2, 4, 7,
		...
		38, 40, 42, 44, 46, 48, 50, 52, 0, 9, 2, 0, 3, 7, 21, 21, 1, 0, 8, 9, 1,
		0, 25, 26, 3, 0, 29, 29, 31, 31, 50, 50, 2, 0, 2, 2, 13, 14, 1, 0, 15,
		17, 1, 0, 42, 45, 3, 0, 30, 30, 40, 41, 50, 50, 2, 0, 19, 20, 25, 26, 309,
		...
		76, 1, 1, 0, 0, 0, 77, 75, 1, 0, 0, 0, 78, 83, 3, 4, 2, 0, 79, 80, 5, 38,
		0, 0, 80, 82, 3, 4, 2, 0, 81, 79, 1, 0, 0, 0, 82, 85, 1, 0, 0, 0, 83, 81,
		1, 0, 0, 0, 83, 84, 1, 0, 0, 0, 84, 3, 1, 0, 0, 0, 85, 83, 1, 0, 0, 0,
		86, 91, 3, 6, 3, 0, 87, 88, 5, 37, 0, 0, 88, 90, 3, 6, 3, 0, 89, 87, 1,
		...
		113, 123, 5, 33, 0, 0, 114, 119, 3, 48, 24, 0, 115, 116, 5, 37, 0, 0, 116,
		...
		123, 124, 1, 0, 0, 0, 124, 125, 1, 0, 0, 0, 125, 126, 5, 34, 0, 0, 126,
		11, 1, 0, 0, 0, 127, 128, 7, 0, 0, 0, 128, 13, 1, 0, 0, 0, 129, 130, 5,
		22, 0, 0, 130, 131, 5, 33, 0, 0, 131, 134, 3, 16, 8, 0, 132, 133, 5, 37,
		0, 0, 133, 135, 3, 48, 24, 0, 134, 132, 1, 0, 0, 0, 134, 135, 1, 0, 0,
		0, 135, 136, 1, 0, 0, 0, 136, 137, 5, 34, 0, 0, 137, 15, 1, 0, 0, 0, 138,
		140, 5, 49, 0, 0, 139, 138, 1, 0, 0, 0, 139, 140, 1, 0, 0, 0, 140, 141,
		1, 0, 0, 0, 141, 143, 5, 48, 0, 0, 142, 144, 3, 36, 18, 0, 143, 142, 1,
		0, 0, 0, 143, 144, 1, 0, 0, 0, 144, 17, 1, 0, 0, 0, 145, 146, 7, 1, 0,
		0, 146, 19, 1, 0, 0, 0, 147, 153, 5, 10, 0, 0, 148, 150, 5, 33, 0, 0, 149,
		151, 3, 32, 16, 0, 150, 149, 1, 0, 0, 0, 150, 151, 1, 0, 0, 0, 151, 152,
		1, 0, 0, 0, 152, 154, 5, 34, 0, 0, 153, 148, 1, 0, 0, 0, 153, 154, 1, 0,
		0, 0, 154, 156, 1, 0, 0, 0, 155, 157, 3, 36, 18, 0, 156, 155, 1, 0, 0,
		0, 156, 157, 1, 0, 0, 0, 157, 21, 1, 0, 0, 0, 158, 159, 5, 23, 0, 0, 159,
		161, 5, 33, 0, 0, 160, 162, 3, 48, 24, 0, 161, 160, 1, 0, 0, 0, 161, 162,
		1, 0, 0, 0, 162, 163, 1, 0, 0, 0, 163, 164, 5, 34, 0, 0, 164, 23, 1, 0,
		0, 0, 165, 168, 3, 32, 16, 0, 166, 168, 3, 10, 5, 0, 167, 165, 1, 0, 0,
		0, 167, 166, 1, 0, 0, 0, 168, 25, 1, 0, 0, 0, 169, 170, 5, 24, 0, 0, 170,
		171, 5, 33, 0, 0, 171, 176, 3, 24, 12, 0, 172, 173, 5, 37, 0, 0, 173, 175,
		3, 24, 12, 0, 174, 172, 1, 0, 0, 0, 175, 178, 1, 0, 0, 0, 176, 174, 1,
		0, 0, 0, 176, 177, 1, 0, 0, 0, 177, 179, 1, 0, 0, 0, 178, 176, 1, 0, 0,
		0, 179, 180, 5, 34, 0, 0, 180, 27, 1, 0, 0, 0, 181, 183, 3, 32, 16, 0,
		182, 184, 7, 2, 0, 0, 183, 182, 1, 0, 0, 0, 183, 184, 1, 0, 0, 0, 184,
		29, 1, 0, 0, 0, 185, 186, 5, 27, 0, 0, 186, 187, 5, 33, 0, 0, 187, 192,
		3, 28, 14, 0, 188, 189, 5, 37, 0, 0, 189, 191, 3, 28, 14, 0, 190, 188,
		1, 0, 0, 0, 191, 194, 1, 0, 0, 0, 192, 190, 1, 0, 0, 0, 192, 193, 1, 0,
		0, 0, 193, 195, 1, 0, 0, 0, 194, 192, 1, 0, 0, 0, 195, 196, 5, 34, 0, 0,
		196, 31, 1, 0, 0, 0, 197, 199, 5, 48, 0, 0, 198, 200, 5, 48, 0, 0, 199,
		198, 1, 0, 0, 0, 199, 200, 1, 0, 0, 0, 200, 33, 1, 0, 0, 0, 201, 203, 3,
		32, 16, 0, 202, 204, 3, 36, 18, 0, 203, 202, 1, 0, 0, 0, 203, 204, 1, 0,
		0, 0, 204, 35, 1, 0, 0, 0, 205, 209, 5, 28, 0, 0, 206, 207, 5, 39, 0, 0,
		207, 209, 7, 3, 0, 0, 208, 205, 1, 0, 0, 0, 208, 206, 1, 0, 0, 0, 209,
		37, 1, 0, 0, 0, 210, 211, 5, 29, 0, 0, 211, 39, 1, 0, 0, 0, 212, 213, 5,
		49, 0, 0, 213, 214, 5, 48, 0, 0, 214, 41, 1, 0, 0, 0, 215, 216, 5, 49,
		0, 0, 216, 43, 1, 0, 0, 0, 217, 226, 5, 11, 0, 0, 218, 219, 5, 40, 0, 0,
		219, 220, 5, 39, 0, 0, 220, 227, 5, 40, 0, 0, 221, 222, 5, 40, 0, 0, 222,
		227, 5, 39, 0, 0, 223, 224, 5, 39, 0, 0, 224, 227, 5, 40, 0, 0, 225, 227,
		5, 40, 0, 0, 226, 218, 1, 0, 0, 0, 226, 221, 1, 0, 0, 0, 226, 223, 1, 0,
		0, 0, 226, 225, 1, 0, 0, 0, 226, 227, 1, 0, 0, 0, 227, 228, 1, 0, 0, 0,
		228, 229, 5, 36, 0, 0, 229, 45, 1, 0, 0, 0, 230, 232, 3, 48, 24, 0, 231,
		233, 3, 36, 18, 0, 232, 231, 1, 0, 0, 0, 232, 233, 1, 0, 0, 0, 233, 47,
		1, 0, 0, 0, 234, 235, 6, 24, -1, 0, 235, 236, 5, 33, 0, 0, 236, 237, 3,
		48, 24, 0, 237, 238, 5, 34, 0, 0, 238, 247, 1, 0, 0, 0, 239, 247, 3, 32,
		...
		1, 0, 0, 0, 248, 249, 10, 8, 0, 0, 249, 250, 5, 12, 0, 0, 250, 274, 3,
		...
		267, 10, 3, 0, 0, 264, 268, 5, 47, 0, 0, 265, 268, 5, 46, 0, 0, 266, 268,
		1, 0, 0, 0, 267, 264, 1, 0, 0, 0, 267, 265, 1, 0, 0, 0, 267, 266, 1, 0,
		0, 0, 268, 269, 1, 0, 0, 0, 269, 274, 3, 48, 24, 4, 270, 271, 10, 2, 0,
		0, 271, 272, 5, 18, 0, 0, 272, 274, 3, 48, 24, 3, 273, 248, 1, 0, 0, 0,
...
func (p *SLQParser) UniqueFunc() (localctx IUniqueFuncContext) {
	...
	p.EnterOuterAlt(localctx, 1)
	{
		...
		if !(_la == SLQParserT__7 || _la == SLQParserT__8) {
			p.GetErrorHandler().RecoverInline(p)
		} else {
			p.GetErrorHandler().ReportMatch(p)
			p.Consume()
...
func (p *SLQParser) Where() (localctx IWhereContext) {
	...
	if (int64(_la) & ^0x3f) == 0 && ((int64(1)<<_la)&1410683723317496) != 0 {
		{
			p.SetState(160)
			p.expr(0)
		}
...
func (p *SLQParser) Alias() (localctx IAliasContext) {
	...
	case SLQParserCOLON:
		...
		}
		{
			...
			if !((int64(_la) & ^0x3f) == 0 && ((int64(1)<<_la)&1125902591197184) != 0) {
				p.GetErrorHandler().RecoverInline(p)
			} else {
				p.GetErrorHandler().ReportMatch(p)
				p.Consume()
...
func (p *SLQParser) Literal() (localctx ILiteralContext) {
	...
	p.EnterOuterAlt(localctx, 1)
	{
		...
		if !((int64(_la) & ^0x3f) == 0 && ((int64(1)<<_la)&1129199515467776) != 0) {
			p.GetErrorHandler().RecoverInline(p)
		} else {
			p.GetErrorHandler().ReportMatch(p)
			p.Consume()
...
func (p *SLQParser) UnaryOperator() (localctx IUnaryOperatorContext) {
	...
	p.EnterOuterAlt(localctx, 1)
	{
		...
		if !((int64(_la) & ^0x3f) == 0 && ((int64(1)<<_la)&102236160) != 0) {
			p.GetErrorHandler().RecoverInline(p)
		} else {
			p.GetErrorHandler().ReportMatch(p)
			p.Consume()
