	...
	testCases := []queryTestCase{
		{
			...
			override:     driverMap{drivertype.TypeMy: "SELECT `first_name`, `last_name` FROM `actor`"},
		...
		},
		{
			...
			override:     driverMap{drivertype.TypeMy: "SELECT `first name` FROM `actor`"},
			wantRecCount: sakila.TblActorCount,
			skipExec:     true,
		},
		{
			...
			override:     driverMap{drivertype.TypeMy: "SELECT `actor_id`, `first name`, `last name` FROM `actor`"},
			wantRecCount: sakila.TblActorCount,
			skipExec:     true,
		},
		{
			...
			override: driverMap{drivertype.TypeMy: "SELECT * FROM `film actor`"},
			skipExec: true,
		},
		{
			name:         "cols-aliases",
			...
			override:     driverMap{drivertype.TypeMy: "SELECT `first_name` AS `given_name`, `last_name` AS `family_name` FROM `actor`"},
			wantRecCount: sakila.TblActorCount,
		},
		{
			...
			override:     driverMap{drivertype.TypeMy: "SELECT `first_name` AS `Given Name`, `last_name` AS `family_name` FROM `actor`"},
			wantRecCount: sakila.TblActorCount,
		},
		{
		...
		},
		{
			...
			override:     driverMap{drivertype.TypeMy: "SELECT `first_name`, 'xxx' AS `xxx`, `last_name` FROM `actor`"},
			wantRecCount: sakila.TblActorCount,
		},
		{
			name:         "select/literal",
			...
			override:     driverMap{drivertype.TypeMy: "SELECT `first_name`, 5 AS `5` FROM `actor`"},
			wantRecCount: sakila.TblActorCount,
		},
	}
