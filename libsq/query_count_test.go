	...
	testCases := []queryTestCase{
		{
			...
			override: driverMap{
				drivertype.MySQL:      "SELECT count(*) AS `quantity` FROM `actor`",
		...
		},
		{
			...
			override: driverMap{
				drivertype.MySQL:      "SELECT count(*) AS `count` FROM `actor`",
				drivertype.ClickHouse: "SELECT count(*) AS `count` FROM `actor`",
			},
			wantRecCount: 1,
		},
		{
			...
			override: driverMap{
				drivertype.MySQL:      "SELECT count(`first name`) FROM `actor`",
				drivertype.ClickHouse: "SELECT count(`first name`) FROM `actor`",
			},
			skipExec: true,
		},
		{
		...
		},
		{
			...
			override: driverMap{
				drivertype.MySQL:      "SELECT count(*) AS `unique` FROM `actor`",
				drivertype.ClickHouse: "SELECT count(*) AS `unique` FROM `actor`",
			},
			wantRecCount: 1,
		},
		{
			...
			override: driverMap{
				drivertype.MySQL:      "SELECT count(*) AS `something_123` FROM `actor`",
				drivertype.ClickHouse: "SELECT count(*) AS `something_123` FROM `actor`",
			},
			wantRecCount: 1,
		},
		{
		...
		},
		{
			...
			override: driverMap{
				drivertype.MySQL:      "SELECT count(`first_name`) FROM `actor`",
				drivertype.ClickHouse: "SELECT count(`first_name`) FROM `actor`",
			},
			wantRecCount: 1,
		},
		{
