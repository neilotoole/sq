	...
	testCases := []queryTestCase{
		{
			...
			override: driverMap{
				drivertype.MySQL:      "SELECT * FROM `actor` ORDER BY `first_name`",
				drivertype.ClickHouse: "SELECT * FROM `actor` ORDER BY `first_name`",
			},
		...
		},
		{
			...
			override: driverMap{
				drivertype.MySQL:      "SELECT * FROM `actor` ORDER BY `actor`.`first_name`",
				drivertype.ClickHouse: "SELECT * FROM `actor` ORDER BY `actor`.`first_name`",
			},
			wantRecCount: sakila.TblActorCount,
		},
		{
			...
			override: driverMap{
				drivertype.MySQL:      "SELECT * FROM `actor` ORDER BY `first_name` ASC",
				drivertype.ClickHouse: "SELECT * FROM `actor` ORDER BY `first_name` ASC",
			},
			wantRecCount: sakila.TblActorCount,
		},
		{
			...
			override: driverMap{
				drivertype.MySQL:      "SELECT * FROM `actor` ORDER BY `first_name` DESC",
				drivertype.ClickHouse: "SELECT * FROM `actor` ORDER BY `first_name` DESC",
			},
			wantRecCount: sakila.TblActorCount,
		},
		{
			...
			override: driverMap{
				drivertype.MySQL:      "SELECT * FROM `actor` ORDER BY `first_name` ASC, `last_name` DESC",
				drivertype.ClickHouse: "SELECT * FROM `actor` ORDER BY `first_name` ASC, `last_name` DESC",
			},
			wantRecCount: sakila.TblActorCount,
		},
		{
